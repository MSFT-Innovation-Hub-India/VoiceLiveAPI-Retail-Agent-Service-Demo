...
# this is a copy paste of the code in https://learn.microsoft.com/en-us/azure/ai-services/speech-service/voice-live-agents-quickstart?tabs=windows%2Ckeyless&pivots=programming-language-python
import os
import uuid
import json
import time
...
def main() -> None: 
    ...
    print("project_name:", project_name, "agent_id:", agent_id)
    try:
    ...
    print("Am I Connected to Voice Live API.?",connection._connected)
    session_update = {
        "type": "session.update",
        "session": {
            "turn_detection": {
...
class AzureVoiceLive:
    ...
    def connect(self, project_name: str, agent_id: str, agent_access_token: str) -> VoiceLiveConnection:
        ...
        # print(f"Connecting to Voice Live API at {url}")
